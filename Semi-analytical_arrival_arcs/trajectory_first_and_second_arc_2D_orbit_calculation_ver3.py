...
choose_flyby_pericenter_then = ...  # m
choose_flyby_beta_angle_then = ...  # rad
...
first_arc_orbital_energy = first_arc_departure_velocity ** 2 / 2 - jupiter_gravitational_parameter / first_arc_departure_radius
...
if not skip_regula_falsi:
    ...
    fpa_a, beta_angle_a = calculate_fpa_from_flyby_geometry_simplified(pericenter_radius=interval_left_boundary_a,
    ...
    fpa_b, beta_angle_b = calculate_fpa_from_flyby_geometry_simplified(pericenter_radius=interval_right_boundary_b,
                                                         arc_1_initial_velocity=first_arc_departure_velocity,
                                                         arc_1_initial_radius=first_arc_departure_radius,
                                                         delta_hoh=delta_angle_from_hohmann_trajectory,
                                                         arc_2_final_radius=second_arc_arrival_radius,
    ...
    for i in range(max_iter):
        ...
        fpa_c, beta_angle_c = calculate_fpa_from_flyby_geometry_simplified(pericenter_radius=c_point,
                                                             arc_1_initial_velocity=first_arc_departure_velocity,
                                                             arc_1_initial_radius=first_arc_departure_radius,
                                                             delta_hoh=delta_angle_from_hohmann_trajectory,
                                                             arc_2_final_radius=second_arc_arrival_radius,
    ...
    flyby_pericenter = choose_flyby_pericenter_then
    flyby_beta_angle = choose_flyby_beta_angle_then
    calculated_fpa = -10
########################################################################################################################
...
flyby_pericenter_position = rotate_vectors_by_given_matrix(rotation_matrix(orbit_axis, flyby_beta_angle), unit_vector(-moon_velocity)) * flyby_pericenter

# Energy and angular momentum for first arc are calculated above

first_arc_arrival_position = moon_position + flyby_pericenter_position
first_arc_arrival_radius = LA.norm(first_arc_arrival_position)
first_arc_arrival_velocity = np.sqrt(2 * (first_arc_orbital_energy + jupiter_gravitational_parameter / first_arc_arrival_radius))
...
second_arc_departure_position = moon_position + flyby_pericenter_position
...
second_arc_orbital_energy = second_arc_departure_velocity ** 2 / 2 - jupiter_gravitational_parameter / second_arc_departure_radius

second_arc_arrival_velocity = np.sqrt(2 * (second_arc_orbital_energy + jupiter_gravitational_parameter / second_arc_arrival_radius))
