...
def phi_function_zero_second_order(x_tau, delta_parameter, c, k1, k_lower, alpha_const, eta_const, lambda_constant):
    ...
    x_0, = regula_falsi_illinois((-1000,1000), phi_function_zero_first_order, entry_phi_fpa_dep_variable=c, k1=k1, alpha_const=alpha_const)
    ...
    tau__x_0, = regula_falsi_illinois((-1000,1000), x_tau_function,x_0, a1=a1, a2=a2, a3=a3)
...
def second_order_approximation_aerocapture(...,entry_radius, entry_velocity, entry_flight_path_angle, C_D0 = vehicle_cd, C_L = vehicle_cl, K_hypersonic = 0., vehicle_mass = vehicle_mass, vehicle_surface = vehicle_reference_area, nose_radius = vehicle_radius):
    ...
    entry_g_acc = central_body_gravitational_parameter/entry_radius**2
